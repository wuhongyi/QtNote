...
static const char qt_meta_stringdata_Palette[] = {
    "Palette\0\0pen\0penChanged(QPen&)\0brush\0"
    "brushChanged(QBrush&)\0penChanged()\0"
    "brushChanged()\0"
};
...
const QMetaObjectExtraData Palette::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Palette::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Palette,
      qt_meta_data_Palette, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Palette::getStaticMetaObject() { return staticMetaObject; }
...
// SIGNAL 0
void Palette::penChanged(QPen & _t1)
{
...
// SIGNAL 1
void Palette::brushChanged(QBrush & _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
